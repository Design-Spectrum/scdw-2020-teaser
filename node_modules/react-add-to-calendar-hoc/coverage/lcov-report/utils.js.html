 ...
 */
export const isMobile = () =&gt; /Mobile|iP(hone|od|ad)|Android|BlackBerry|IEMobile/.test(window.navigator.userAgent || <span class="branch-1 cbranch-no" title="branch not covered" >window.navigator.vendor </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >window.opera)</span>;
&nbsp;
/**
...
const googleShareUrl = ({
  ...
  `https://calendar.google.com/calendar/render?action=TEMPLATE&amp;dates=${
    startDatetime
  }/${endDatetime}${timezone &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >`&amp;ctz=${timezone}`}</span>&amp;location=${location}&amp;text=${title}&amp;details=${description}`;
&nbsp;
/**
...
const buildShareFile = ({
  description = <span class="branch-0 cbranch-no" title="branch not covered" >'',</span>
  ctz = '',
  endDatetime,
  location = <span class="branch-0 cbranch-no" title="branch not covered" >'',</span>
  startDatetime,
  timezone = <span class="branch-0 cbranch-no" title="branch not covered" >'',</span>
  title = <span class="branch-0 cbranch-no" title="branch not covered" >'',</span>
}) =&gt; {
  let content = [
    'BEGIN:VCALENDAR',
    'VERSION:2.0',
    ...
    timezone === '' ? `DTSTART:${startDatetime}` : <span class="branch-1 cbranch-no" title="branch not covered" >`DTSTART;TZID=${timezone}:${startDatetime}`,</span>
    timezone === '' ? `DTEND:${endDatetime}` : <span class="branch-1 cbranch-no" title="branch not covered" >`DTEND;TZID=${timezone}:${endDatetime}`,</span>
    `SUMMARY:${title}`,
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Jun 25 2020 16:05:06 GMT-0400 (Eastern Daylight Time)
</div>
</div>
